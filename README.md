...
🆕 **v2.0** (2026-07-22) — **เปลี่ยนวิธีแปลทั้งระบบ**: เพิ่มปลั๊กอินที่ใส่คำแปล**ตรงตามรหัสประจำบรรทัดของเกม** แทนการจับคู่ด้วยข้อความ → ปลดล็อก 3 อย่างที่เดิมทำไม่ได้เลย (**ข้อความซ้ำ 12,761 รหัสที่ต้องแปลต่างกัน** · **อักษรจีนตัวเดียว** ที่ v1.2 ต้องปิดทิ้ง 97 บรรทัด เช่น `ปี 三` → **`ปีที่ 3`**, ปุ่ม 修/练 → **ฝึก/ฝน** · **ข้อความที่มีตัวเลขเปลี่ยนได้** เช่น `近战伤害{0}` → **ความเสียหายประชิด 10**) ครอบคลุม **98.13%** ของทั้งเกม, แก้สำนวนชาย/หญิงเพิ่ม 66 จุด, และ**รอดจากการอัปเดตเกมในอนาคต** — ดู `RELEASE-NOTES-v2.0.md`
